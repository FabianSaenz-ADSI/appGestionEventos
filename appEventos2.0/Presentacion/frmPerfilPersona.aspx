<%@ Page Title="" Language="C#" MasterPageFile="~/Presentacion/Site1.Master" AutoEventWireup="true" CodeBehind="frmPerfilPersona.aspx.cs" Inherits="appEventos2._0.Presentacion.frmPerfilPersona" %>
        ...
        <div class="row g-0">
            <div class="col-md-12 bg-dark d-flex align-items-center">
                <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                    ...
                    <h1 class="text-white mb-4 nav-link  fa fa-user me-3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Mi perfil</h1>
                    <form>
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <asp:Button ID="btnEditar" runat="server" Text="Actualizar Datos" CssClass="btn btn-primary w-100 py-3" OnClick="btnEditar_Click" />

                               
                            </div>
                            <div class="col-md-6">

                                 <asp:Button runat="server" Text="Eliminar" ID="btnEliminar" CssClass="btn btn-primary w-100 py-3" OnClick="btnEliminar_Click" />
