...
exports.initModalContent = exports.injectElIntoModal = void 0;
...
var injectElIntoModal = function (markup) {
    var modal = utils_1.getNode(MODAL);
    var el = utils_1.stringToNode(markup);
    modal.appendChild(el);
    return el;
};
exports.injectElIntoModal = injectElIntoModal;
/*
 ...
 */
var initModalContent = function (opts) {
    // Start from scratch:
    var modal = utils_1.getNode(MODAL);
...
exports.initModalContent = initModalContent;
